...
\begin{document}
    \begin{minipage}[t]{0.495\textwidth}
        ...
        \begin{problem}{\bfseries\large Problem}
            Relationship between \textbf{adversarial robustness} and \textbf{generalization}: {\bfseries\color{MPIIblue}are accurate \emph{and} robust models possible?}
        \end{problem}
        ...
        \begin{minipage}[t]{0.14\textwidth}
            ...
            \vspace*{-1.25mm}
            \hspace*{-2.25mm}\includegraphics[width=20mm]{gfx/cvpr2019}
        \end{minipage}
        ...
        \begin{data}{\bfseries\large FONTS (Synthetic)}
            ...
            \node[anchor=east] at (-1.75, -0.25){\small \begin{tabular}{r@{}}affine\\transformation\end{tabular}};
            ...
            \node[anchor=west] at (1, 0){\includegraphics[height=3cm,trim={0 12.5cm 0 0cm},clip]{gfx/fonts}};
            
            %\node at (0.5,-2){\bfseries Approximated Manifold};
            \end{tikzpicture}
        \end{data}
    
        \begin{data}{\bfseries\large EMNIST}
            \centering
